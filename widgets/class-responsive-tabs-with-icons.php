...
class Responsive_Tabs_With_Icons extends Widget_Base
{
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    wp_register_style('responsive-tabs', plugins_url('/assets/css/responsive-tabs.min.css', RESPONSIVE_TABS_FOR_ELEMENTOR), [], RESPONSIVE_TABS_VERSION);
    ...
    if (get_plugin_data(ELEMENTOR__FILE__)['Version'] >= "3.5.0") {
      wp_register_script('responsive-tabs', plugins_url('/assets/js/responsive-tabs-widget-handler' . $direction . '.min.js', RESPONSIVE_TABS_FOR_ELEMENTOR), ['elementor-frontend'], RESPONSIVE_TABS_VERSION, true);
    } else {
      wp_register_script('responsive-tabs', plugins_url('/assets/js/responsive-tabs-widget-old-elementor-handler' . $direction . '.min.js', RESPONSIVE_TABS_FOR_ELEMENTOR), ['elementor-frontend'], RESPONSIVE_TABS_VERSION, true);
    }
  }
  ...
  protected function _register_controls()
  {
    ...
    $this->add_control(
      ...
      [
        ...
        'type'      => Controls_Manager::COLOR,
        'selectors' => [
          '{{WRAPPER}} .responsive-tabs-section .responsive-tab.active-tab .responsive-tab-info .responsive-tab-icon > a'          => 'color: {{VALUE}}',
          '{{WRAPPER}} .responsive-tabs-section .responsive-tab.active-tab .responsive-tab-info .responsive-tab-icon > a svg path' => 'fill: {{VALUE}}',
        ],
      ]
    );
    $this->add_control(
            ...
            <li id="<?php echo esc_attr("responsive-tab-$counter") ?>" class="responsive-tab-content <?php if (
              ...
              <?php if ($item['sub_tabs_to_show'] > '0') { ?>
                  ...
                  <?php for ($i = 1; $i <= (int)$item['sub_tabs_to_show']; $i++) { ?>
                    <li class="sub-tab-name <?php if ($i === 1) { ?>active-sub-tab<?php } ?>">
                      ...
                      <div class="accordion-item-body">
                        <div
                            class="sub-tab-content-mobile"><?php echo wp_kses($item["sub_tab_content_" . $i], []); ?></div>
                      </div>
                    </li>
                  <?php } ?>
                </ul>
                <ul class="responsive-sub-tab-content">
                  <?php for ($i = 1; $i <= (int)$item['sub_tabs_to_show']; $i++) { ?>
                    <li id="<?php echo esc_attr("responsive-sub-tab-$counter-$i") ?>"
                        class="sub-tab-content <?php if ($i === 1) {
                          echo 'active-sub-tab';
                        } ?>">
