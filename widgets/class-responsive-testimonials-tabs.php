...
class Responsive_Testimonials_Tabs extends Widget_Base
{
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    wp_register_style('responsive-testimonials-tabs', plugins_url('/assets/css/responsive-testimonials-tabs.min.css', RESPONSIVE_TABS_FOR_ELEMENTOR), [], RESPONSIVE_TABS_VERSION);
          ...
          <div class="cards-wrapper">
            ...
            foreach ($settings['tab'] as $item) { ?>
              <div class="card <?php if ($counter === 1) { ?>active<?php } ?>"
                   data-id="content-<?php echo esc_attr($counter); ?>">
        ...
        <div class="content">
          ...
          foreach ($settings['tab'] as $item) { ?>
            <div class="contentBox <?php if ($counter === 1) { ?>active<?php } ?>"
                 id="content-<?php echo esc_attr($counter); ?>">
              <div class="text">
