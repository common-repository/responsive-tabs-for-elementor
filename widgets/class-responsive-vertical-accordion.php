...
class Responsive_Vertical_Accordion extends Widget_Base
{
  ...
  public function __construct($data = [], $args = null)
  {
    ...
    wp_register_style('responsive-vertical-accordion', plugins_url('/assets/css/responsive-vertical-accordion.min.css', RESPONSIVE_TABS_FOR_ELEMENTOR), [], RESPONSIVE_TABS_VERSION);
